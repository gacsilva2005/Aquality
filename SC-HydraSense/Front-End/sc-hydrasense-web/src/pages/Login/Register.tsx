...
const CLUBES_DISPONIVEIS = [
    { id: 1, nome: "América-SP" },
    { id: 2, nome: "Audax" },
    { id: 3, nome: "Água Santa" },
    { id: 4, nome: "Bandeirante" },
    { id: 5, nome: "Barretos" },
    { id: 6, nome: "Botafogo-SP" },
    { id: 7, nome: "Bragantino" },
    { id: 8, nome: "Capivariano" },
    { id: 9, nome: "Catanduvense" },
    { id: 10, nome: "Comercial-SP" },
    { id: 11, nome: "Corinthians" },
    { id: 12, nome: "Desportivo Brasil" },
    { id: 13, nome: "EC São Bernardo" },
    { id: 14, nome: "Ferroviária" },
    { id: 15, nome: "Francana" },
    { id: 16, nome: "Gremio" },
    { id: 17, nome: "Guarani" },
    { id: 18, nome: "Inter de Limeira" },
    { id: 19, nome: "Ipiranga" },
    { id: 20, nome: "Itapirense" },
    { id: 21, nome: "Ituano" },
    { id: 22, nome: "Juventus" },
    { id: 23, nome: "Linense" },
    { id: 24, nome: "Marília" },
    { id: 25, nome: "Matonense" },
    { id: 26, nome: "Mogi Mirim" },
    { id: 27, nome: "Nacional" },
    { id: 28, nome: "Noroeste" },
    { id: 29, nome: "Novorizontino" },
    { id: 30, nome: "Oeste" },
    { id: 31, nome: "Olímpia" },
    { id: 32, nome: "Palmeiras" },
    { id: 33, nome: "Paulista" },
    { id: 34, nome: "Penapolense" },
    { id: 35, nome: "Ponte Preta" },
    { id: 36, nome: "Portuguesa" },
    { id: 37, nome: "Portuguesa Santista" },
    { id: 38, nome: "Primavera" },
    { id: 39, nome: "Rio Claro" },
    { id: 40, nome: "Santo André" },
    { id: 41, nome: "Santos" },
    { id: 42, nome: "São Bento" },
    { id: 43, nome: "São Bernardo FC" },
    { id: 44, nome: "São Caetano" },
    { id: 45, nome: "São Paulo" },
    { id: 46, nome: "Taubaté" },
    { id: 47, nome: "União Barbarense" },
    { id: 48, nome: "Velo Clube" },
    { id: 49, nome: "XV de Jaú" },
    { id: 50, nome: "XV de Piracicaba" }
];
